...
CREATE TABLE APPLICATION (id integer not null, created_by varchar(20), created_date timestamp, updated_by varchar(20), updated_date timestamp, application_date date, customer_id integer not null, remarks varchar(255), primary key (id));
